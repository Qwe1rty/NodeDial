...
private object ChordialServer extends App {
  ...
  implicit val actorSystem: ActorSystem[Nothing] = ActorSystem(Behaviors.setup {
    context: ActorContext[Nothing] => new AbstractBehavior[Nothing](context: ActorContext[Nothing]) {
